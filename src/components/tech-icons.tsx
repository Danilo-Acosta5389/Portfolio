...
//                   alt={
//                     "An image of a software development tool or programming language"
//                   }
//                 />
//               </div>
//             ) : null
...
export function TechIconsCard({ i, theme }: { i: number; theme: string }) {
  ...
  return (
    ...
    >
      ...
      <img
        width={150}
        src={`${techIconsBaseUrl}${iconsArr[i]}${iconsTheme}`}
        alt="Card conatining image of a software development tool or langugage"
      />
    </div>
  );
}
