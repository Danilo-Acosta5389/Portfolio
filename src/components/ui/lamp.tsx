...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "flex h-[500px] pt-72 flex-col items-center justify-center overflow-hidden bg-background w-full rounded-md",
        className
      )}
    >
      ...
      <div className="relative z-30 flex -translate-y-10 flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
